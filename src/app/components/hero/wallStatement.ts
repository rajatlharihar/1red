 ...
 * "Still hiring five agencies for one job?" lettered on the facade to the
...
export const STATEMENT = 'Still hiring five agencies for one job?';
...
const BREAKS: string[][] = [
  ['STILL HIRING', 'FIVE AGENCIES', 'FOR ONE JOB?'],
  ['STILL HIRING', 'FIVE', 'AGENCIES', 'FOR ONE JOB?'],
  ['STILL', 'HIRING', 'FIVE', 'AGENCIES', 'FOR ONE', 'JOB?'],
];
